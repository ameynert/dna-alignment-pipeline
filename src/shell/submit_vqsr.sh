...
# apply recalibration
java -Xmx4g -jar $ngs_gatk -T ApplyRecalibration -R $ngs_reference_seq.fasta --input $JOB_NAME.raw.vcf.gz -recalFile $JOB_NAME.snps.recal -tranchesFile $JOB_NAME.snps.tranches -o $JOB_NAME.snps.recal.vcf.gz --ts_filter_level 99.5 -mode SNP &> $ngs_logs_dir/$JOB_NAME.snps.applyrecalibration.log
